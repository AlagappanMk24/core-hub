// types/invoice-form.types.ts

import { Attachment } from "../interfaces/invoice/invoice.interface";
...
export type DiscountTypeDisplay = 'Percentage' | 'Fixed' | 'EarlyPayment' | 'Volume' | 'Promotional';
