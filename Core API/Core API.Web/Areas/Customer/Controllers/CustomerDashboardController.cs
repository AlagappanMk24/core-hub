...
namespace Core_API.Web.Areas.Customer.Controllers
{
  
    [Route("api/customer-dashboard")]
    [ApiController]
    [Authorize(Policy = "Customer")]
    public class CustomerDashboardController(ICustomerInvoiceService customerInvoiceService, ILogger<CustomerDashboardController> logger) : ControllerBase
    {
