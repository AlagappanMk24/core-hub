...
{
    public class RecurringInvoiceRepository(CoreInvoiceDbContext dbContext, ILogger<RecurringInvoiceRepository> logger) : GenericRepository<Domain.Entities.RecurringInvoices.RecurringInvoice>(dbContext), IRecurringInvoiceRepository
    {
        ...
        public async Task<PaginatedResult<Domain.Entities.RecurringInvoices.RecurringInvoice>> GetPagedAsync(
            int companyId,
            RecurringInvoiceFilterDto filter)
        {
            try
            {
                IQueryable<Domain.Entities.RecurringInvoices.RecurringInvoice> query = _dbSet
                ...
                return new PaginatedResult<Domain.Entities.RecurringInvoices.RecurringInvoice>
                {
                    Items = items,
        ...
        public async Task<List<Domain.Entities.RecurringInvoices.RecurringInvoice>> GetDueInvoicesAsync(DateTime asOfDate)
        {
            try
            {
                return await _dbSet
        ...
        public async Task<Domain.Entities.RecurringInvoices.RecurringInvoice> GetWithDetailsAsync(int id, int companyId)
        {
            try
            {
                return await _dbSet
        ...
        public async Task<bool> ExistsAsync(int companyId, string name, int? excludeId = null)
        {
            try
            {
                var query = _dbSet.Where(r => r.CompanyId == companyId && r.Name == name && !r.IsDeleted);
        ...
        public async Task<List<Domain.Entities.RecurringInvoices.RecurringInvoice>> GetByCustomerAsync(int customerId, int companyId)
        {
            try
            {
                return await _dbSet
        ...
        private IQueryable<Domain.Entities.RecurringInvoices.RecurringInvoice> ApplySorting(
            IQueryable<Domain.Entities.RecurringInvoices.RecurringInvoice> query,
            string sortBy,
            string sortOrder)
        {
