    ...
    private async Task SeedDataAsync(CancellationToken cancellationToken)
    {
        try
        {
            ...
            var invoicesToSeed = new[]
            {
                ...
                new Invoice
                {
                    InvoiceNumber = "INV-002", PONumber = "PO-002", IssueDate = DateTime.UtcNow.AddDays(-20), DueDate = DateTime.UtcNow.AddDays(-5),
                ...
                new Invoice
                {
                    InvoiceNumber = "INV-003", PONumber = "PO-003", IssueDate = DateTime.UtcNow.AddDays(-10), DueDate = DateTime.UtcNow.AddDays(5),
                ...
                new Invoice
                {
                    InvoiceNumber = "INV-004", PONumber = "PO-004", IssueDate = DateTime.UtcNow.AddDays(-5), DueDate = DateTime.UtcNow.AddDays(10),
                ...
                new Invoice
                {
                    InvoiceNumber = "INV-005", PONumber = "PO-005", IssueDate = DateTime.UtcNow.AddDays(-25), DueDate = DateTime.UtcNow.AddDays(-10),
                ...
                new Invoice
                {
                    InvoiceNumber = "INV-006", PONumber = "PO-006", IssueDate = DateTime.UtcNow.AddDays(-15), DueDate = DateTime.UtcNow,
                    InvoiceStatus = InvoiceStatus.Approved, PaymentStatus = PaymentStatus.Overdue,
                ...
                new Invoice
                {
                    InvoiceNumber = "INV-007", PONumber = "PO-007", IssueDate = DateTime.UtcNow.AddDays(-8), DueDate = DateTime.UtcNow.AddDays(7),
                    InvoiceStatus = InvoiceStatus.Sent, PaymentStatus = PaymentStatus.Pending,
                    InvoiceType = InvoiceType.Standard,
                ...
                new Invoice
                {
                    InvoiceNumber = "INV-008", PONumber = "PO-008", IssueDate = DateTime.UtcNow.AddDays(-3), DueDate = DateTime.UtcNow.AddDays(12),
                ...
                new Invoice
                {
                    InvoiceNumber = "INV-009", PONumber = "PO-009", IssueDate = DateTime.UtcNow.AddDays(-12), DueDate = DateTime.UtcNow.AddDays(3),
                    InvoiceStatus = InvoiceStatus.Sent, PaymentStatus = PaymentStatus.Pending,
                    InvoiceType = InvoiceType.Standard,
                ...
                new Invoice
                {
                    InvoiceNumber = "INV-010", PONumber = "PO-010", IssueDate = DateTime.UtcNow.AddDays(-18), DueDate = DateTime.UtcNow.AddDays(-3),
                    InvoiceStatus = InvoiceStatus.Approved, PaymentStatus = PaymentStatus.Overdue,
                    InvoiceType = InvoiceType.Standard,
                ...
                new Invoice
                {
                    InvoiceNumber = "INV-011", PONumber = "PO-011", IssueDate = DateTime.UtcNow.AddDays(-7), DueDate = DateTime.UtcNow.AddDays(8),
                    InvoiceStatus = InvoiceStatus.Sent, PaymentStatus = PaymentStatus.Pending,
                    InvoiceType = InvoiceType.Standard,
                ...
                new Invoice
                {
                    InvoiceNumber = "INV-012", PONumber = "PO-012", IssueDate = DateTime.UtcNow.AddDays(-2), DueDate = DateTime.UtcNow.AddDays(13),
                    InvoiceStatus = InvoiceStatus.Draft, PaymentStatus = PaymentStatus.Pending,
                    InvoiceType = InvoiceType.Proforma,
                ...
                new Invoice
                {
                    InvoiceNumber = "INV-014", PONumber = "PO-014", IssueDate = DateTime.UtcNow.AddDays(-35), DueDate = DateTime.UtcNow.AddDays(-20),
                    InvoiceStatus = InvoiceStatus.Approved, PaymentStatus = PaymentStatus.Overdue,
                    InvoiceType = InvoiceType.Standard,
                ...
                new Invoice
                {
                    InvoiceNumber = "INV-015", PONumber = "PO-015", IssueDate = DateTime.UtcNow.AddDays(-28), DueDate = DateTime.UtcNow.AddDays(-10),
                    InvoiceStatus = InvoiceStatus.Approved, PaymentStatus = PaymentStatus.PartiallyPaid,
                    InvoiceType = InvoiceType.Standard,
                ...
                new Invoice
                {
                    InvoiceNumber = "INV-017", PONumber = "PO-017", IssueDate = DateTime.UtcNow.AddDays(-18), DueDate = DateTime.UtcNow.AddDays(2),
                    InvoiceStatus = InvoiceStatus.Sent, PaymentStatus = PaymentStatus.Pending,
                    InvoiceType = InvoiceType.Standard,
                    CustomerId = customerMap["alagappantest@gmail.com"], CompanyId = companyMap["KL Infotech"],
                ...
                new Invoice
                {
                    InvoiceNumber = "INV-018", PONumber = "PO-018", IssueDate = DateTime.UtcNow.AddDays(-12), DueDate = DateTime.UtcNow.AddDays(7),
                    InvoiceStatus = InvoiceStatus.Draft, PaymentStatus = PaymentStatus.Pending,
                    InvoiceType = InvoiceType.Proforma,
                    CustomerId = customerMap["billing@acmecorp.com"], CompanyId = companyMap["KL Infotech"],
                ...
                new Invoice
                {
                    InvoiceNumber = "INV-020", PONumber = "PO-020", IssueDate = DateTime.UtcNow.AddDays(-7), DueDate = DateTime.UtcNow.AddDays(14),
                    InvoiceStatus = InvoiceStatus.Draft, PaymentStatus = PaymentStatus.Pending,
                    InvoiceType = InvoiceType.Proforma,
                    CustomerId = customerMap["alagappantest@gmail.com"], CompanyId = companyMap["KL Infotech"],
                ...
                new Invoice
                {
                    InvoiceNumber = "INV-021", PONumber = "PO-021", IssueDate = DateTime.UtcNow.AddDays(-6), DueDate = DateTime.UtcNow.AddDays(5),
                    InvoiceStatus = InvoiceStatus.Approved, PaymentStatus = PaymentStatus.PartiallyPaid,
                    InvoiceType = InvoiceType.Recurring,
                    CustomerId = customerMap["billing@acmecorp.com"], CompanyId = companyMap["KL Infotech"],
                ...
                new Invoice
                {
                    InvoiceNumber = "INV-022", PONumber = "PO-022", IssueDate = DateTime.UtcNow.AddDays(-4), DueDate = DateTime.UtcNow.AddDays(10),
                    InvoiceStatus = InvoiceStatus.Sent, PaymentStatus = PaymentStatus.Pending,
                    InvoiceType = InvoiceType.Standard,
                ...
                new Invoice
                {
                    InvoiceNumber = "INV-023", PONumber = "PO-023", IssueDate = DateTime.UtcNow.AddDays(-3), DueDate = DateTime.UtcNow.AddDays(12),
                    InvoiceStatus = InvoiceStatus.Sent, PaymentStatus = PaymentStatus.Pending,
                    InvoiceType = InvoiceType.Standard,
                ...
                new Invoice
                {
                    InvoiceNumber = "INV-024", PONumber = "PO-024", IssueDate = DateTime.UtcNow.AddDays(-1), DueDate = DateTime.UtcNow.AddDays(15),
                    InvoiceStatus = InvoiceStatus.Approved, PaymentStatus = PaymentStatus.PartiallyPaid,
                    InvoiceType = InvoiceType.Standard,
            ...
            var invoiceAttachments = new[]
            {
                // INV-001
                new InvoiceAttachment
                {
                    FileName = "INV-001_Signed_Contract.pdf",
                    FileUrl = "/uploads/Invoices/INV-001/INV-001_Signed_Contract.pdf",
                    InvoiceId = invoicesToSeed[0].Id,
                    CreatedBy = "system",
                    CreatedDate = DateTime.UtcNow.AddDays(-30)
                },
                new InvoiceAttachment
                {
                    FileName = "INV-001_Payment_Receipt.pdf",
                    FileUrl = "/Uploads/Invoices/INV-001/INV-001_Payment_Receipt.pdf",
                    InvoiceId = invoicesToSeed[0].Id,
                    CreatedBy = "system",
                ...
                new InvoiceAttachment
                {
                    ...
                    FileUrl = "/Uploads/Invoices/INV-002/INV-002_Design_Specs.pdf",
                    InvoiceId = invoicesToSeed[1].Id,
                    CreatedBy = "system",
                ...
                new InvoiceAttachment
                {
                    FileName = "INV-003_ERP_Consultancy_Report.pdf",
                    FileUrl = "/Uploads/Invoices/INV-003/INV-003_ERP_Consultancy_Report.pdf",
                    InvoiceId = invoicesToSeed[2].Id,
                    CreatedBy = "system",
                    CreatedDate = DateTime.UtcNow.AddDays(-10)
                },
                new InvoiceAttachment
                {
                    FileName = "INV-003_Client_Approval_Email.pdf",
                    FileUrl = "/Uploads/Invoices/INV-003/INV-003_Client_Approval_Email.pdf",
                    InvoiceId = invoicesToSeed[2].Id,
                    CreatedBy = "system",
                ...
                new InvoiceAttachment
                {
                    FileName = "INV-004_Market_Research_Draft.pdf",
                    FileUrl = "/Uploads/Invoices/INV-004/INV-004_Market_Research_Draft.pdf",
                    InvoiceId = invoicesToSeed[3].Id,
                    CreatedBy = "system",
                ...
                new InvoiceAttachment
                {
                    FileName = "INV-005_Server_Upgrade_Specs.pdf",
                    FileUrl = "/Uploads/Invoices/INV-005/INV-005_Server_Upgrade_Specs.pdf",
                    InvoiceId = invoicesToSeed[4].Id,
                    CreatedBy = "system",
                    CreatedDate = DateTime.UtcNow.AddDays(-25)
                },
                new InvoiceAttachment
                {
                    FileName = "INV-005_Partial_Payment_Proof.pdf",
                    FileUrl = "/Uploads/Invoices/INV-005/INV-005_Partial_Payment_Proof.pdf",
                    InvoiceId = invoicesToSeed[4].Id,
                    CreatedBy = "system",
                ...
                new InvoiceAttachment
                {
                    FileName = "INV-006_Cloud_Hosting_Agreement.pdf",
                    FileUrl = "/Uploads/Invoices/INV-006/INV-006_Cloud_Hosting_Agreement.pdf",
                    InvoiceId = invoicesToSeed[5].Id,
                    CreatedBy = "system",
                ...
                new InvoiceAttachment
                {
                    FileName = "INV-007_Security_Test_Report.pdf",
                    FileUrl = "/Uploads/Invoices/INV-007/INV-007_Security_Test_Report.pdf",
                    InvoiceId = invoicesToSeed[6].Id,
                    CreatedBy = "system",
                ...
                new InvoiceAttachment
                {
                    FileName = "INV-008_Return_Policy_Document.pdf",
                    FileUrl = "/Uploads/Invoices/INV-008/INV-008_Return_Policy_Document.pdf",
                    InvoiceId = invoicesToSeed[7].Id,
                    CreatedBy = "system",
                    CreatedDate = DateTime.UtcNow.AddDays(-3)
                },
                new InvoiceAttachment
                {
                    FileName = "INV-008_Refund_Confirmation.pdf",
                    FileUrl = "/Uploads/Invoices/INV-008/INV-008_Refund_Confirmation.pdf",
                    InvoiceId = invoicesToSeed[7].Id,
                    CreatedBy = "system",
                ...
                new InvoiceAttachment
                {
                    FileName = "INV-009_Brand_Guidelines.pdf",
                    FileUrl = "/Uploads/Invoices/INV-009/INV-009_Brand_Guidelines.pdf",
                    InvoiceId = invoicesToSeed[8].Id,
                    CreatedBy = "system",
                ...
                new InvoiceAttachment
                {
                    FileName = "INV-010_SEO_Strategy_Document.pdf",
                    FileUrl = "/Uploads/Invoices/INV-010/INV-010_SEO_Strategy_Document.pdf",
                    InvoiceId = invoicesToSeed[9].Id,
                    CreatedBy = "system",
                ...
                new InvoiceAttachment
                {
                    FileName = "INV-011_Consulting_Report.pdf",
                    FileUrl = "/Uploads/Invoices/INV-011/INV-011_Consulting_Report.pdf",
                    InvoiceId = invoicesToSeed[10].Id,
                    CreatedBy = "system",
                ...
                new InvoiceAttachment
                {
                    FileName = "INV-012_Software_Specs_Draft.pdf",
                    FileUrl = "/Uploads/Invoices/INV-012/INV-012_Software_Specs_Draft.pdf",
                    InvoiceId = invoicesToSeed[11].Id,
                    CreatedBy = "system",
                    CreatedDate = DateTime.UtcNow.AddDays(-2)
                },
                ...
                new InvoiceAttachment
                {
                    FileName = "INV-013_AWS_Migration_Plan.pdf",
                    FileUrl = "/Uploads/Invoices/INV-013/INV-013_AWS_Migration_Plan.pdf",
                    InvoiceId = invoicesToSeed[12].Id,
                    CreatedBy = "system",
                    CreatedDate = DateTime.UtcNow.AddDays(-40)
                },
                new InvoiceAttachment
                {
                    FileName = "INV-013_Payment_Confirmation.pdf",
                    FileUrl = "/Uploads/Invoices/INV-013/INV-013_Payment_Confirmation.pdf",
                    InvoiceId = invoicesToSeed[12].Id,
                    CreatedBy = "system",
                    CreatedDate = DateTime.UtcNow.AddDays(-39)
                },

                // INV-014
                new InvoiceAttachment
                {
                    FileName = "INV-014_IT_Support_Contract.pdf",
                    FileUrl = "/Uploads/Invoices/INV-014/INV-014_IT_Support_Contract.pdf",
                    InvoiceId = invoicesToSeed[13].Id,
                    CreatedBy = "system",
                ...
                new InvoiceAttachment
                {
                    FileName = "INV-015_Web_Dev_Specs.pdf",
                    FileUrl = "/Uploads/Invoices/INV-015/INV-015_Web_Dev_Specs.pdf",
                    InvoiceId = invoicesToSeed[14].Id,
                    CreatedBy = "system",
                    CreatedDate = DateTime.UtcNow.AddDays(-28)
                },
                new InvoiceAttachment
                {
                    FileName = "INV-015_Partial_Payment_Receipt.pdf",
                    FileUrl = "/Uploads/Invoices/INV-015/INV-015_Partial_Payment_Receipt.pdf",
                    InvoiceId = invoicesToSeed[14].Id,
                    CreatedBy = "system",
                ...
                new InvoiceAttachment
                {
                    FileName = "INV-016_SEO_Report.pdf",
                    FileUrl = "/Uploads/Invoices/INV-016/INV-016_SEO_Report.pdf",
                    InvoiceId = invoicesToSeed[15].Id,
                    CreatedBy = "system",
                ...
                new InvoiceAttachment
                {
                    FileName = "INV-017_Packaging_Designs.pdf",
                    FileUrl = "/Uploads/Invoices/INV-017/INV-017_Packaging_Designs.pdf",
                    InvoiceId = invoicesToSeed[16].Id,
                    CreatedBy = "system",
                    CreatedDate = DateTime.UtcNow.AddDays(-18)
                },
                ...
                new InvoiceAttachment
                {
                    FileName = "INV-018_Feasibility_Study_Draft.pdf",
                    FileUrl = "/Uploads/Invoices/INV-018/INV-018_Feasibility_Study_Draft.pdf",
                    InvoiceId = invoicesToSeed[17].Id,
                    CreatedBy = "system",
                    CreatedDate = DateTime.UtcNow.AddDays(-12)
                },
                ...
                new InvoiceAttachment
                {
                    FileName = "INV-019_API_Documentation.pdf",
                    FileUrl = "/Uploads/Invoices/INV-019/INV-019_API_Documentation.pdf",
                    InvoiceId = invoicesToSeed[18].Id,
                    CreatedBy = "system",
                    CreatedDate = DateTime.UtcNow.AddDays(-10)
                },
                ...
                new InvoiceAttachment
                {
                    FileName = "INV-020_UX_Research_Draft.pdf",
                    FileUrl = "/Uploads/Invoices/INV-020/INV-020_UX_Research_Draft.pdf",
                    InvoiceId = invoicesToSeed[19].Id,
                    CreatedBy = "system",
                    CreatedDate = DateTime.UtcNow.AddDays(-7)
                },
                ...
                new InvoiceAttachment
                {
                    FileName = "INV-021_SaaS_Agreement.pdf",
                    FileUrl = "/Uploads/Invoices/INV-021/INV-021_SaaS_Agreement.pdf",
                    InvoiceId = invoicesToSeed[20].Id,
                    CreatedBy = "system",
                    CreatedDate = DateTime.UtcNow.AddDays(-6)
                },
                new InvoiceAttachment
                {
                    FileName = "INV-021_Partial_Payment_Proof.pdf",
                    FileUrl = "/Uploads/Invoices/INV-021/INV-021_Partial_Payment_Proof.pdf",
                    InvoiceId = invoicesToSeed[20].Id,
                    CreatedBy = "system",
                    CreatedDate = DateTime.UtcNow.AddDays(-5)
                },
                ...
                new InvoiceAttachment
                {
                    FileName = "INV-022_Database_Optimization_Report.pdf",
                    FileUrl = "/Uploads/Invoices/INV-022/INV-022_Database_Optimization_Report.pdf",
                    InvoiceId = invoicesToSeed[21].Id,
                    CreatedBy = "system",
                ...
                new InvoiceAttachment
                {
                    FileName = "INV-023_Testing_Suite_Docs.pdf",
                    FileUrl = "/Uploads/Invoices/INV-023/INV-023_Testing_Suite_Docs.pdf",
                    InvoiceId = invoicesToSeed[22].Id,
                    CreatedBy = "system",
                    CreatedDate = DateTime.UtcNow.AddDays(-3)
                },
                ...
                new InvoiceAttachment
                {
                    FileName = "INV-024_Compliance_Audit_Report.pdf",
                    FileUrl = "/Uploads/Invoices/INV-024/INV-024_Compliance_Audit_Report.pdf",
                    InvoiceId = invoicesToSeed[23].Id,
                    CreatedBy = "system",
                    CreatedDate = DateTime.UtcNow.AddDays(-1)
                },
                new InvoiceAttachment
                {
                    FileName = "INV-024_Partial_Payment_Confirmation.pdf",
                    FileUrl = "/Uploads/Invoices/INV-024/INV-024_Partial_Payment_Confirmation.pdf",
                    InvoiceId = invoicesToSeed[23].Id,
                    CreatedBy = "system",
            ...
            if (newInvoices.Any())
            {
                _dbContext.InvoiceAttachments.AddRange(invoiceAttachments);
                await _dbContext.SaveChangesAsync(cancellationToken);
                _logger.LogInformation("Seeded {Count} invoice attachments.", invoiceAttachments.Length);
            }
            else
            {
                _logger.LogInformation("No new invoice attachments to seed.");
            }
