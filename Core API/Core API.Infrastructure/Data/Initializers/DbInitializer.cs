...
public class DbInitializer(UserManager<ApplicationUser> userManager, RoleManager<IdentityRole> roleManager, CoreInvoiceDbContext dbContext, IPermissionService permissionService, ILogger<DbInitializer> logger) : IDbInitializer
{
        ...
        try
        {
            ...
            customersToSeed.AddRange(new[]
            {
                ...
                new Customer {
                    ...
                    CompanyId = companyMap["KL Infotech"],
                    Address = new Address {
                        Address1 = "303 Jasmine Apt",
                        Address2 = "Tower A, Flat 1204",
                        City = "Bangalore",
                        State = "Karnataka",
                        Country = "India",
                        ZipCode = "560001"
            ...
            customersToSeed.AddRange(new[]
            {
                ...
                new Customer {
                    ...
                    PhoneNumber = "+1-206-555-0119",
                    CompanyId = companyMap["Tech Solutions Inc."],
                    Address = new Address {
                        Address1 = "606 Pinecrest Dr",
                        Address2 = null,
                        City = "Seattle",
                        State = "WA",
                        Country = "USA",
            ...
            customersToSeed.AddRange(new[]
            {
                new Customer {
                    ...
                    PhoneNumber = "+61-2-5550-0106",
                    CompanyId = companyMap["Global Enterprises"],
                    Address = new Address {
                        Address1 = "303 Cedar Ave",
                        Address2 = "Level 8",
                        City = "Sydney",
                        State = "NSW",
                        Country = "Australia",
    ...
    private async Task SeedCustomerUsersAsync(Dictionary<string, int> customerMap, Dictionary<string, int> companyMap, CancellationToken cancellationToken)
    {
        ...
        {
            new {
                Customer = customerMap["alagappanmk984@gmail.com"],
            ...
            new {
                Customer = customerMap["sarah.j@example.com"],
                User = new ApplicationUser
                {
        ...
        foreach (var item in customerUsers)
        {
            ...
            if (existingUser != null)
            {
                ...
                {
                    existingUser.CustomerId = item.Customer;
            ...
            if (!creationResult.Succeeded)
            {
                _logger.LogError("Failed to create customer user {Email}", item.User.Email);
                continue;
            }
