...
using Core_API.Application.DTOs.Users.Request;
using Core_API.Application.DTOs.Users.Response;
...
namespace Core_API.Infrastructure.Services.User
{
       ...
       IConfiguration configuration) : IUserService
       {
        ...
        public async Task<OperationResult<string>> CreateUserAsync(UserDto userDto, string currentUserId)
        {
            try
            {
                ...
                // Send welcome email
                await _emailServiceProvider.SendWelcomeEmailAsync(welcomeEmailRequest);
            ...
            try
            {
                using (var transaction = await _dbContext.Database.BeginTransactionAsync())
                {
                    ...
                    if (deletedCount > 0)
                    {
                        ...
                        await _emailServiceProvider.SendCleanupReportEmailAsync(emailRequest);
