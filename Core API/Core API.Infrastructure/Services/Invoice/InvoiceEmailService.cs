...
namespace Core_API.Infrastructure.Services.Invoice
{
        ...
        ILogger<InvoiceEmailService> logger) : IInvoiceEmailService
    {
        ...
        public async Task<bool> SendInvoiceEmailAsync(Domain.Entities.Invoice invoice, EmailDataDto emailData, OperationContext operationContext)
        {
            try
            {
                ...
                await _emailSendingService.SendInvoiceEmailAsync(
                    emailRequest, operationContext, pdfStream, $"Invoice_{invoice.InvoiceNumber}.pdf");
        ...
        public string GenerateDefaultEmailMessage(Domain.Entities.Invoice invoice)
        {
            return $@"
            <html>
            <body>
        ...
        public InvoiceEmailRequest PrepareEmailRequest(Domain.Entities.Invoice invoice, EmailDataDto emailData)
        {
