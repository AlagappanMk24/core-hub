...
namespace Core_API.Infrastructure.Services.Invoice
{
    ...
    public class InvoiceStatisticsService(IUnitOfWork unitOfWork, ILogger<InvoiceStatisticsService> logger) : IInvoiceStatisticsService
    {
        ...
        private decimal CalculateChangeForStatus(List<Domain.Entities.Invoice> invoices, InvoiceStatus status, DateTime previousPeriodStart, DateTime currentPeriodStart)
        {
        ...
        private decimal CalculateChangeForPaymentStatus(List<Domain.Entities.Invoice> invoices, PaymentStatus status, DateTime previousPeriodStart, DateTime currentPeriodStart)
        {
