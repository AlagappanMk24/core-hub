...
namespace Core_API.Infrastructure.Services.Invoice
{
    public class InvoiceAttachmentService(IUnitOfWork unitOfWork, ILogger<InvoiceAttachmentService> logger) : IInvoiceAttachmentService
    {
        ...
        public async Task<List<InvoiceAttachment>> HandleAttachmentsAsync(List<InvoiceAttachmentDto> attachmentDtos, int companyId, int invoiceId, string userId)
        {
        ...
        public List<InvoiceAttachment> CopyAttachments(List<InvoiceAttachment> originalAttachments, int companyId, string userId)
        {
