...
namespace Core_API.Infrastructure.Services.Background.RecurringInvoice
{
    /// <summary>
    ...
    /// </summary>
    public class RecurringInvoiceBackgroundService(
        IServiceProvider serviceProvider,
        ILogger<RecurringInvoiceBackgroundService> logger) : BackgroundService
    {
        private readonly IServiceProvider _serviceProvider = serviceProvider ?? throw new ArgumentNullException(nameof(serviceProvider));
        private readonly ILogger<RecurringInvoiceBackgroundService> _logger = logger ?? throw new ArgumentNullException(nameof(logger));
        ...
        /// </summary>
        private async System.Threading.Tasks.Task ProcessDueRecurringInvoices(CancellationToken stoppingToken)
        {
        ...
        private async Task<bool> ProcessSingleRecurringInvoice(
            Domain.Entities.RecurringInvoices.RecurringInvoice recurringInvoice,
        ...
        /// </summary>
        private async System.Threading.Tasks.Task ProcessFailedGenerations(CancellationToken stoppingToken)
        {
            using var scope = _serviceProvider.CreateScope();
            var unitOfWork = scope.ServiceProvider.GetRequiredService<IUnitOfWork>();
            var recurringService = scope.ServiceProvider.GetRequiredService<IRecurringInvoiceService>();
        ...
        /// </summary>
        private async System.Threading.Tasks.Task MarkGenerationFailed(
            IUnitOfWork unitOfWork,
        ...
        /// </summary>
        private async System.Threading.Tasks.Task MarkGenerationPermanentlyFailed(
            IUnitOfWork unitOfWork,
        ...
        /// </summary>
        private async System.Threading.Tasks.Task SendInvoiceEmailNotification(
            ...
            CancellationToken cancellationToken)
        {
            try
            {
                ...
                {
                    To = new List<string> { customer.Email.Value },
        ...
        /// </summary>
        private async System.Threading.Tasks.Task LogGenerationAudit(
            IUnitOfWork unitOfWork,
            int recurringInvoiceId,
            int invoiceId,
        ...
        /// </summary>
        private string GenerateEmailMessage(InvoiceResponseDto invoice, Domain.Entities.RecurringInvoices.RecurringInvoice recurring)
        {
            return $@"
                <html>
                <head>
