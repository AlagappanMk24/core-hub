...
{
    public class UserRepository(CoreAPIDbContext context, UserManager<ApplicationUser> userManager) : GenericRepository<ApplicationUser>(context), IUserRepository
    {
