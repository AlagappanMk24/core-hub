        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PhoneNumber_NationalNumber = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    PhoneNumber_CountryCodeAlpha2 = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_InvoiceSequences", x => x.CompanyId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CustomerGroups_Companies",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EnableItemLevelDiscounts = table.Column<bool>(type: "bit", nullable: false),
                    EnableOverallDiscounts = table.Column<bool>(type: "bit", nullable: false),
                    DefaultDiscountType = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    ...
                    ApplyDiscountBeforeTax = table.Column<bool>(type: "bit", nullable: false),
                    ShowDiscountColumnOnInvoice = table.Column<bool>(type: "bit", nullable: false),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    UpdatedDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EmailLocalPart = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    PhoneNumber = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    PhoneCountryCode = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: false),
                    PhoneNationalNumber = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    PhoneCountryCodeAlpha2 = table.Column<string>(type: "nvarchar(2)", maxLength: 2, nullable: true),
                    ...
                    TotalPurchases = table.Column<decimal>(type: "decimal(18,2)", nullable: false, defaultValue: 0m),
                    AveragePaymentDays = table.Column<int>(type: "int", nullable: true),
                    CompanyId = table.Column<int>(type: "int", nullable: false),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    UpdatedDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Customers_CustomerGroups",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastOtpAttemptIp = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CustomerNotes_Customers",
                        column: x => x.CustomerId,
                        principalSchema: "dbo",
                        principalTable: "Customers",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TaskAuditLogs_AspNetUsers_PerformedByUserId",
                        column: x => x.PerformedByUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_TaskAuditLogs_TaskItems_TaskId",
                        column: x => x.TaskId,
                        principalTable: "TaskItems",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_InvoicePayments_Customers_CustomerId",
                        column: x => x.CustomerId,
                        principalSchema: "dbo",
                        principalTable: "Customers",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalAmount = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    BaseCurrencySubtotal = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    BaseCurrencyTotalAmount = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    BaseCurrencyAmountPaid = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    BaseCurrencyAmountDue = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CustomerContacts_CustomerId_Primary",
                schema: "dbo",
                table: "CustomerContacts",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CustomerDocuments_CustomerId_Type",
                schema: "dbo",
                table: "CustomerDocuments",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CustomerDocuments_Type",
                schema: "dbo",
                table: "CustomerDocuments",
                column: "Type");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CustomerNotes_CustomerId_Pinned",
                schema: "dbo",
                table: "CustomerNotes",
                columns: new[] { "CustomerId", "IsPinned" },
                filter: "[IsDeleted] = 0");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CustomerNotes_IsPinned",
                schema: "dbo",
                table: "CustomerNotes",
                column: "IsPinned");

            migrationBuilder.CreateIndex(
                name: "IX_CustomerNotes_Type",
                schema: "dbo",
                table: "CustomerNotes",
                column: "Type");

            migrationBuilder.CreateIndex(
                name: "IX_Customers_Company_Status_Deleted",
                schema: "dbo",
                table: "Customers",
                columns: new[] { "CompanyId", "Status", "IsDeleted" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InvoicePayments_CustomerId",
                table: "InvoicePayments",
                column: "CustomerId");
