...
/// </summary>
public record UpdateInvoiceCommand : BaseCommand<InvoiceResponseDto>
{
    /// <summary>
    /// Invoice ID
    /// </summary>
    ...
    /// <summary>
    /// Creates an UpdateInvoiceCommand from UpdateInvoiceDto
    /// </summary>
    public static UpdateInvoiceCommand FromDto(UpdateInvoiceDto dto)
    {
