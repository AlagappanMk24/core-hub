...
namespace Core_API.Application.DTOs.Invoice.Request
{
    public class InvoiceSettingsDto
    {
        ...
        public bool EnableOverallDiscounts { get; set; } = false;      // Conservative default
        public string DefaultDiscountType { get; set; } = "Percentage";
        public int MaxDiscountPercentage { get; set; } = 25;           // 25% default
        public decimal MaxDiscountAmount { get; set; } = 500;          // $500 default
        public bool AllowMultipleDiscounts { get; set; } = false;      // Stacking disabled
        public bool ApplyDiscountBeforeTax { get; set; } = true;
        public bool ShowDiscountColumnOnInvoice { get; set; } = true;   // Note: Different name
    }
}
