...
namespace Core_API.Application.Contracts.Services.Invoice
{
    ...
    public interface IInvoiceEmailService
    {
        ...
        /// </summary>
        Task<bool> SendInvoiceEmailAsync(Domain.Entities.Invoice invoice, EmailDataDto emailData, OperationContext operationContext);

        /// <summary>
        /// Generates default HTML email message for invoice
        /// </summary>
        string GenerateDefaultEmailMessage(Domain.Entities.Invoice invoice);

        /// <summary>
        /// Prepares email request from invoice data
        /// </summary>
        InvoiceEmailRequest PrepareEmailRequest(Domain.Entities.Invoice invoice, EmailDataDto emailData);
