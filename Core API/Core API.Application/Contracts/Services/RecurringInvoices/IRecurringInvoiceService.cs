...
namespace Core_API.Application.Contracts.Services.RecurringInvoices
{
    /// <summary>
    ...
    public interface IRecurringInvoiceService
    {
        ...
        /// </summary>
        Task<OperationResult<RecurringInvoiceResponseDto>> CreateAsync(CreateRecurringInvoiceDto dto, OperationContext context);

        /// <summary>
        /// Updates an existing recurring invoice template
        /// </summary>
        Task<OperationResult<RecurringInvoiceResponseDto>> UpdateAsync(UpdateRecurringInvoiceDto dto, OperationContext context);
