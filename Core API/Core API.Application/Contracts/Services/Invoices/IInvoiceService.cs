...
namespace Core_API.Application.Contracts.Services.Invoices
{
    ...
    public interface IInvoiceService
    {
        ...
        /// </summary>
        Task<OperationResult<InvoiceResponseDto>> CreateAsync(CreateInvoiceDto dto, OperationContext operationContext);

        /// <summary>
        /// Updates an existing invoice
        /// </summary>
        Task<OperationResult<InvoiceResponseDto>> UpdateAsync(UpdateInvoiceDto dto, OperationContext operationContext);
        ...
        /// </summary>
        InvoiceResponseDto MapToInvoiceResponseDto(Domain.Entities.Invoices.Invoice invoice);
    }
}